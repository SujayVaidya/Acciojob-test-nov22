...
const Footer = () => {
    ...
    const handleSubmit = (event) =>{
        ...
        if(email ===""){
            ...
            fetch('https://acciojob-mart-default-rtdb.firebaseio.com/message.json',
            {
                method: 'POST',
                ...
                <div className="container-social">
                    <div className="row-social">
                        <div className="col-md-31">
                            <div className="brand"><h3><span>AccioJob</span></h3></div>
                        </div>
...
<rect width="24" height="19.7647" fill="white" transform="translate(0.5 0.117676)"/>
                        ...
                        <div className="col-md-25">
                            ...
                            <div className="subscribe">
                                <span className="input-grp">
                                    ...
                                    value={email} onChange={handleEmailRequest} />
                                    <button type="submit" className='btn'  id='submit'><p> Subscribe</p></button>
                                    <p className='extra'>Lorem ipsum dolor sit amet </p>
                                </form>
                                </span>
            ...
            <div className="lowest">
                <div className="lowest-container">
                    <div className="lowest-row"><div className="lowest-col-md">
                        <p><h6> Made With ❤️ at Acciojob</h6></p></div></div>
                </div>
            </div>
